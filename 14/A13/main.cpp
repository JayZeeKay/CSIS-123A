...
Lab Assignment 13 - Exceptions

Creating an exception handling scheme using the try-throw-catch triad
*/
...
{ 
    ...
    */
    ...
    cout << "biteOne bits: " << biteOne->toString() << endl;
    cout << "biteOne val: " << biteOne->toInt() << endl;
    cout << "biteTwo bits: " << biteTwo->toString() << endl;
    cout << "biteTwo val: " << biteTwo->toInt() << endl;
